...
<script>
    document.getElementById("footwears").classList.add("border-b-2", "border-black", "dark:border-white", "bg-gray-100", "dark:bg-gray-700");
    document.getElementById("footwear").classList.add("border-b-2", "border-black", "dark:border-white");
...
<script>
    ...
    fetch(FULL_URL)
        ...
        .then(data => {
            ...
            const product = reversedData.filter(product => product.category === 'Footwear');
