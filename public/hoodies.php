...
<script>
    ...
    document.getElementById("hoodies").classList.add("border-b-2", "border-black", "dark:border-white", "bg-gray-100", "dark:bg-gray-700");//for desktop navbar
    document.getElementById("hoodie").classList.add("border-b-2", "border-black", "dark:border-white"); //for mobile navbar because ids are unique
...
<script>
    ...
    fetch(FULL_URL)
        ...
        .then(data => {
            ...
            const product = reversedData.filter(product => product.category === 'Hoodie');
