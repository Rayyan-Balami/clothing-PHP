...
<script>
    ...
    document.getElementById("all-tops").classList.add("border-b-2", "border-black", "dark:border-white", "bg-gray-100", "dark:bg-gray-700");//for desktop navbar
...
<script>
    ...
    fetch(FULL_URL)
        ...
        .then(data => {
            ...
            const product = reversedData.filter(product => product.category === 'T-Shirt' || product.category === 'Shirt' || product.category === 'Hoodie');
