...
<div class="fixed z-40 w-full px-4 pb-2 lg:px-16 lg:mx-auto text-lg font-semibold flex items-center gap-3 bg-white dark:bg-black">
 <p class="py-2">All Accessories</p>
</div>
...
<script>
    document.getElementById("accessories").classList.add("border-b-2", "border-black", "dark:border-white", "bg-gray-100", "dark:bg-gray-700");
    document.getElementById("accessorie").classList.add("border-b-2", "border-black", "dark:border-white");
...
<script>
    ...
    fetch(FULL_URL)
        ...
        .then(data => {
            ...
            const product = reversedData.filter(product => product.category === 'Accessorie');
